    ...
    private void getUserInfo() { // get the user infformation from the firebase
        mCustomerDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                //   Toast.makeText(CustomerSettingsActivity.this, "", Toast.LENGTH_SHORT).show();
        ...
        if(resultUri != null) {
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(TaskSnapshot taskSnapshot) {
                    ...
                    Toast.makeText(CustomerSettingsActivity.this, "information updated", Toast.LENGTH_SHORT).show();
                    finish();
                    return;
                }
            });
