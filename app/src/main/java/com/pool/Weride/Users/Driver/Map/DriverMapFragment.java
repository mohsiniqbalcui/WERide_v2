/*
package com.pool.Weride.Users.Driver.Map;
...
public class DriverMapFragment extends Fragment implements OnMapReadyCallback, RoutingListener
{
    ...
    private LatLng destinationLatLng, pickupLatLng;// store the satring and ending latLng from giigle map
    ...
    private SupportMapFragment mapFragment; // to call xml mapfragment
    ...
    /// first learn the flow of the applicatio in our system and ind the which thing creating problem in creating the call from the rider to driver
