package com.pool.Weride.Users.Driver.setting;
    ...
    private void getUserInfo() {
        ...
        mDriverDatabase.addValueEventListener(new ValueEventListener() {
                ...
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0) {
                    ...
                    if (map.get("profileImageUrl") != null) {// first check either the profileimageurl is exist
                        ...
                        Glide.with(getApplication())
                                ...
                                .into(mProfileImage);// Glide library used to render the image in cirlcular view
                    }
                }
            }
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(DriverSettingsActivity.this, "" + databaseError, Toast.LENGTH_SHORT).show();
            }
        });
    }
